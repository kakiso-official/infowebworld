...
/* Generic icons rotated per logo index for non-US countries */
const genericIcons = [
...
export default function Logos() {
  ...
  const countryNames = country?.logos?.names
  const logos = countryNames
    ? countryNames.map((name, i) => ({ name, icon: genericIcons[i % genericIcons.length] }))
    : defaultLogos
  const label = country?.logos?.label || 'Trusted by industry leaders'
