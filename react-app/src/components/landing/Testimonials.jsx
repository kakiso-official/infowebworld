...
export default function Testimonials() {
  ...
  const heroTestimonials = country?.testimonials?.items || defaultTestimonials
  const gridItems = country?.testimonials?.grid || defaultGrid
      ...
      <div className="container">
        <div className="section-header-row">
          <div className="section-header">
            ...
            <h2 className="section-title">{country?.testimonials?.heading || 'Loved by Professionals'}</h2>
            <p className="section-subtitle">{country?.testimonials?.sub || 'Hear from business owners who grew their reach and revenue through InfoWebWorld.'}</p>
          </div>
