    ...
    <footer className="footer fade-section">
      <div className="container">
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <div className="footer-newsletter">
              <div className="footer-newsletter-wrap">
                <svg className="footer-newsletter-icon" viewBox="0 0 24 24" stroke="var(--gray-400)" fill="none" strokeWidth="1.5"><rect x="2" y="4" width="20" height="16" rx="2" /><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" /></svg>
                <input type="email" placeholder="Enter your email" value={email} onChange={e=>setEmail(e.target.value)} />
                <button>Subscribe</button>
              </div>
              <span className="footer-newsletter-hint">Weekly industry insights. No spam.</span>
            </div>
          </div>
          <div>
          ...
          <div>
            <div className="footer-col-title">For Businesses</div>
            <ul className="footer-links">
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-left">
            <span className="footer-copy">2026 InfoWebWorld. All rights reserved.</span>
            <div className="footer-legal"><a href="#">Terms</a><a href="#">Privacy</a><a href="#">Cookies</a></div>
          </div>
