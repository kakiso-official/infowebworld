      ...
      <div className="container">
        <div className="cta-box">
          ...
          <div className="cta-content">
            <div className="cta-badge"><span className="cta-badge-dot"></span>{cta.badge || 'Limited Time Offer'}</div>
            <h2 className="cta-h2">{cta.heading || 'List Your Business Today'}</h2>
            <p className="cta-sub">{cta.sub || 'Join 2,500+ businesses already reaching thousands of qualified customers every month through verified listings and high-authority backlinks.'}</p>
            ...
            <p className="cta-price">{cta.price || 'Starting at $99/year · No hidden fees · Setup in 5 minutes'}</p>
          </div>
        </div>
      </div>
    </section>
