...
export default function Navbar() {
  ...
  const matchedCats = q.length > 0
    ...
    : []
  const showDropdown = searchOpen && (q.length > 0 || true) // always show when open
    ...
    <>
      <nav className={`s-nav${scrolled ? ' scrolled' : ''}`} id="s-nav-bar">
        <div className="s-container s-nav-inner">
          ...
          <div className="s-nav-links">
            <div className="s-mega-wrapper">
              <Link to={`${countryPrefix}/category`} className={`s-nav-link s-nav-link--has-menu ${isActive('/category')}`}>
                Categories <svg viewBox="0 0 24 24"><path d="M6 9l6 6 6-6" /></svg>
              </Link>
              <div className="s-mega-menu">
                <Link to={`${countryPrefix}/category?cat=technology-saas`} className="s-mega-item"><span className="s-mega-icon" style={{background:'rgba(108,114,241,.1)'}}><svg viewBox="0 0 24 24" stroke="var(--accent)"><path d="M16 18l6-6-6-6" /><path d="M8 6l-6 6 6 6" /></svg></span><div><div className="s-mega-text">Technology &amp; SaaS</div><div className="s-mega-count">520+ listings</div></div></Link>
                <Link to={`${countryPrefix}/category?cat=restaurants-food`} className="s-mega-item"><span className="s-mega-icon" style={{background:'rgba(239,107,74,.1)'}}><svg viewBox="0 0 24 24" stroke="var(--coral)"><path d="M3 2v7c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2V2" /><path d="M7 2v20" /><path d="M21 15V2a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3zm0 0v7" /></svg></span><div><div className="s-mega-text">Restaurants &amp; Food</div><div className="s-mega-count">480+ listings</div></div></Link>
                <Link to={`${countryPrefix}/category?cat=healthcare-wellness`} className="s-mega-item"><span className="s-mega-icon" style={{background:'rgba(47,174,106,.1)'}}><svg viewBox="0 0 24 24" stroke="var(--emerald)"><path d="M19.5 12.572l-7.5 7.428-7.5-7.428A5 5 0 1 1 12 6.006a5 5 0 1 1 7.5 6.572" /><path d="M12 6v4" /><path d="M10 8h4" /></svg></span><div><div className="s-mega-text">Healthcare &amp; Wellness</div><div className="s-mega-count">390+ listings</div></div></Link>
                <Link to={`${countryPrefix}/category?cat=real-estate`} className="s-mega-item"><span className="s-mega-icon" style={{background:'rgba(59,130,246,.1)'}}><svg viewBox="0 0 24 24" stroke="var(--azure)"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" /><path d="M9 22V12h6v10" /></svg></span><div><div className="s-mega-text">Real Estate &amp; Property</div><div className="s-mega-count">350+ listings</div></div></Link>
                <Link to={`${countryPrefix}/category?cat=legal-financial`} className="s-mega-item"><span className="s-mega-icon" style={{background:'rgba(139,92,246,.1)'}}><svg viewBox="0 0 24 24" stroke="var(--plum)"><rect x="2" y="7" width="20" height="14" rx="2" /><path d="M16 7V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v3" /><path d="M12 12v2" /></svg></span><div><div className="s-mega-text">Legal &amp; Financial</div><div className="s-mega-count">310+ listings</div></div></Link>
                <Link to={`${countryPrefix}/category?cat=education-training`} className="s-mega-item"><span className="s-mega-icon" style={{background:'rgba(20,184,166,.1)'}}><svg viewBox="0 0 24 24" stroke="var(--teal)"><path d="M22 10v6M2 10l10-5 10 5-10 5z" /><path d="M6 12v5c0 1.66 2.69 3 6 3s6-1.34 6-3v-5" /></svg></span><div><div className="s-mega-text">Education &amp; Training</div><div className="s-mega-count">280+ listings</div></div></Link>
                <Link to={`${countryPrefix}/category?cat=marketing-creative`} className="s-mega-item"><span className="s-mega-icon" style={{background:'rgba(236,72,153,.1)'}}><svg viewBox="0 0 24 24" stroke="var(--rose)"><path d="M3 11l18-5v12L3 13v-2z" /><path d="M11.6 16.8a3 3 0 1 1-5.8-1.6" /></svg></span><div><div className="s-mega-text">Marketing &amp; Creative</div><div className="s-mega-count">420+ listings</div></div></Link>
                <Link to={`${countryPrefix}/category?cat=home-services`} className="s-mega-item"><span className="s-mega-icon" style={{background:'rgba(245,158,11,.1)'}}><svg viewBox="0 0 24 24" stroke="var(--amber)"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z" /></svg></span><div><div className="s-mega-text">Home Services &amp; Trades</div><div className="s-mega-count">360+ listings</div></div></Link>
              </div>
            </div>
            <Link to={`${countryPrefix}/best-of`} className={`s-nav-link ${isActive(`${countryPrefix}/best-of`)}`}>Featured</Link>
            <Link to={`${countryPrefix}/news`} className={`s-nav-link ${isActive(`${countryPrefix}/news`)}`}>News</Link>
            <Link to={`${countryPrefix}/pricing`} className={`s-nav-link ${isActive(`${countryPrefix}/pricing`)}`}>Pricing</Link>
          </div>
          <div className="s-nav-right">
            <button className="s-nav-search" aria-label="Search" onClick={toggleSearch}>
              <svg viewBox="0 0 24 24"><circle cx="11" cy="11" r="8" /><path d="m21 21-4.35-4.35" /></svg>
            </button>
            <Link to={`${countryPrefix}/signin`} className="s-nav-signin">Sign in</Link>
            <Link to={`${countryPrefix}/submit-listing`} className="s-nav-cta">Get Listed</Link>
            <button className="s-nav-mobile-toggle" aria-label="Menu" onClick={openDrawer}><svg viewBox="0 0 24 24"><line x1="3" y1="6" x2="21" y2="6" /><line x1="3" y1="12" x2="21" y2="12" /><line x1="3" y1="18" x2="21" y2="18" /></svg></button>
          </div>
        </div>
      </nav>

      {/* ══════════════════════════════════════════════════════
          NAVBAR LIQUID GLASS SEARCH OVERLAY
          ══════════════════════════════════════════════════════ */}
                ...
                {filtered.length > 0 && (
                  <div className="ns-section">
                    ...
                    {filtered.map((s, i) => (
                      <div
                        key={i}
                        className={`ns-item${activeIdx === i ? ' ns-item--active' : ''}`}
                ...
                {matchedCats.length > 0 && (
                  <div className="ns-section">
                    ...
                    {matchedCats.map((c, i) => (
                      <div
                        key={i}
                        className={`ns-item ns-item--cat${activeIdx === filtered.length + i ? ' ns-item--active' : ''}`}
                        onClick={() => goToCategory(c.slug)}
      ...
      <div className={`s-nav-drawer${drawerOpen ? ' open' : ''}`}>
        ...
        <div className="s-nav-drawer-body">
          <Link to={`${countryPrefix}/search`} className="s-nav-drawer-link">Search</Link>
          <Link to={`${countryPrefix}/best-of`} className="s-nav-drawer-link">Featured</Link>
          <Link to={`${countryPrefix}/news`} className="s-nav-drawer-link">News</Link>
          <Link to={`${countryPrefix}/pricing`} className="s-nav-drawer-link">Pricing</Link>
          <div className="s-nav-drawer-label">Browse Categories</div>
          <Link to={`${countryPrefix}/category?cat=technology-saas`} className="s-nav-drawer-cat"><span className="s-nav-drawer-cat-icon" style={{background:'rgba(108,114,241,.1)'}}><svg viewBox="0 0 24 24" stroke="var(--accent)"><path d="M16 18l6-6-6-6" /><path d="M8 6l-6 6 6 6" /></svg></span>Technology &amp; SaaS</Link>
          <Link to={`${countryPrefix}/category?cat=restaurants-food`} className="s-nav-drawer-cat"><span className="s-nav-drawer-cat-icon" style={{background:'rgba(239,107,74,.1)'}}><svg viewBox="0 0 24 24" stroke="var(--coral)"><path d="M3 2v7c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2V2" /><path d="M7 2v20" /><path d="M21 15V2a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3zm0 0v7" /></svg></span>Restaurants &amp; Food</Link>
          <Link to={`${countryPrefix}/category?cat=healthcare-wellness`} className="s-nav-drawer-cat"><span className="s-nav-drawer-cat-icon" style={{background:'rgba(47,174,106,.1)'}}><svg viewBox="0 0 24 24" stroke="var(--emerald)"><path d="M22 12h-4l-3 9L9 3l-3 9H2" /></svg></span>Healthcare &amp; Wellness</Link>
          <Link to={`${countryPrefix}/category?cat=real-estate`} className="s-nav-drawer-cat"><span className="s-nav-drawer-cat-icon" style={{background:'rgba(59,130,246,.1)'}}><svg viewBox="0 0 24 24" stroke="var(--azure)"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" /><path d="M9 22V12h6v10" /></svg></span>Real Estate &amp; Property</Link>
          <Link to={`${countryPrefix}/category?cat=legal-financial`} className="s-nav-drawer-cat"><span className="s-nav-drawer-cat-icon" style={{background:'rgba(139,92,246,.1)'}}><svg viewBox="0 0 24 24" stroke="var(--plum)"><rect x="2" y="7" width="20" height="14" rx="2" /><path d="M16 7V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v3" /></svg></span>Legal &amp; Financial</Link>
          <Link to={`${countryPrefix}/category?cat=marketing-creative`} className="s-nav-drawer-cat"><span className="s-nav-drawer-cat-icon" style={{background:'rgba(236,72,153,.1)'}}><svg viewBox="0 0 24 24" stroke="var(--rose)"><path d="M3 11l18-5v12L3 13v-2z" /></svg></span>Marketing &amp; Creative</Link>
          <Link to={`${countryPrefix}/category?cat=home-services`} className="s-nav-drawer-cat"><span className="s-nav-drawer-cat-icon" style={{background:'rgba(245,158,11,.1)'}}><svg viewBox="0 0 24 24" stroke="var(--amber)"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z" /></svg></span>Home Services &amp; Trades</Link>
          <Link to={`${countryPrefix}/category?cat=education-training`} className="s-nav-drawer-cat"><span className="s-nav-drawer-cat-icon" style={{background:'rgba(20,184,166,.1)'}}><svg viewBox="0 0 24 24" stroke="var(--teal)"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z" /><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z" /></svg></span>Education &amp; Training</Link>
        </div>
        <div className="s-nav-drawer-footer">
          <Link to={`${countryPrefix}/signin`} className="s-nav-signin">Sign in</Link>
          <Link to={`${countryPrefix}/submit-listing`} className="s-nav-cta">Get Listed</Link>
        </div>
      </div>
