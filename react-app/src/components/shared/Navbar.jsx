    ...
    <>
      <nav className={`s-nav${scrolled ? ' scrolled' : ''}`} id="s-nav-bar">
        <div className="s-container s-nav-inner">
          ...
          <div className="s-nav-right">
            ...
            <Link to="/signin" className="s-nav-signin">Sign in</Link>
            <Link to="/submit-listing" className="s-nav-cta">Get Listed</Link>
      ...
      <div className={`s-nav-drawer${drawerOpen ? ' open' : ''}`}>
        ...
        <div className="s-nav-drawer-body">
          ...
          <Link to="/category?cat=healthcare-wellness" className="s-nav-drawer-cat"><span className="s-nav-drawer-cat-icon" style={{background:'rgba(47,174,106,.1)'}}><svg viewBox="0 0 24 24" stroke="var(--emerald)"><path d="M22 12h-4l-3 9L9 3l-3 9H2" /></svg></span>Healthcare &amp; Wellness</Link>
          <Link to="/category?cat=real-estate" className="s-nav-drawer-cat"><span className="s-nav-drawer-cat-icon" style={{background:'rgba(59,130,246,.1)'}}><svg viewBox="0 0 24 24" stroke="var(--azure)"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" /><path d="M9 22V12h6v10" /></svg></span>Real Estate &amp; Property</Link>
          <Link to="/category?cat=legal-financial" className="s-nav-drawer-cat"><span className="s-nav-drawer-cat-icon" style={{background:'rgba(139,92,246,.1)'}}><svg viewBox="0 0 24 24" stroke="var(--plum)"><rect x="2" y="7" width="20" height="14" rx="2" /><path d="M16 7V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v3" /></svg></span>Legal &amp; Financial</Link>
          <Link to="/category?cat=marketing-creative" className="s-nav-drawer-cat"><span className="s-nav-drawer-cat-icon" style={{background:'rgba(236,72,153,.1)'}}><svg viewBox="0 0 24 24" stroke="var(--rose)"><path d="M3 11l18-5v12L3 13v-2z" /></svg></span>Marketing &amp; Creative</Link>
          <Link to="/category?cat=home-services" className="s-nav-drawer-cat"><span className="s-nav-drawer-cat-icon" style={{background:'rgba(245,158,11,.1)'}}><svg viewBox="0 0 24 24" stroke="var(--amber)"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z" /></svg></span>Home Services &amp; Trades</Link>
          <Link to="/category?cat=education-training" className="s-nav-drawer-cat"><span className="s-nav-drawer-cat-icon" style={{background:'rgba(20,184,166,.1)'}}><svg viewBox="0 0 24 24" stroke="var(--teal)"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z" /><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z" /></svg></span>Education &amp; Training</Link>
        </div>
