...
/* ═══════════════════════════════════════════════════════════════════════
   ...
   Layout:
     ...
     ╭───────────────────────────────────────────────────────╮
     │  🔍  Search businesses, tools, categories  [Search →] │
     ╰───────────────────────────────────────────────────────╯
                    Trending: AI Tools · CRM · Marketing · ...
     stats strip: 13,843 categories · Global coverage · Verified reviews

   Background: pure white base + a soft mint-green radial glow at top,
   subtle dotted lattice for depth (no heavy art, no dark sections).
...
export default function HeroSearchClient() {
  ...
  /* Keyboard shortcuts:
       ...
       - Ctrl/⌘ + K   → focus + select the hero search input from anywhere
                         on the page (matches the common power-user pattern). */
  useEffect(() => {
