          ...
          {step === 5 && (
            <div className="listing-step">
              ...
              <div className="listing-portfolio-note">
                <IconInfo />
                <span><strong>Incubators &amp; Portfolio Companies:</strong> Companies with 5+ tools/apps/startups get free listings. <a href="/contact" style={{ color: '#E8553D', fontWeight: 700 }}>Contact us</a></span>
              </div>
            </div>
          )}
