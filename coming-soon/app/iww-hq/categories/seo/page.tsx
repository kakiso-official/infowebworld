      ...
      <Card title="Meta Tags">
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <div>
            ...
            <input style={inputStyle} value={cat.seoCanonical} onChange={e => setSeo('seoCanonical', e.target.value)} placeholder={`https://infowebworld.com/category/${cat.slug}`} onFocus={focus} onBlur={blur} />
          </div>
