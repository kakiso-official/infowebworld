      ...
      <Card title="Meta Tags">
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <div>
            ...
            <input style={inputStyle} value={seo.canonicalUrl} onChange={e => setSeo('canonicalUrl', e.target.value)} placeholder={`https://www.infowebworld.com/blog/${post.slug}`} onFocus={focus} onBlur={blur} />
          </div>
