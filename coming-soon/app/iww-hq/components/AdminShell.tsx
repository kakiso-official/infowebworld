...
const nav = [
  ...
  { href: '/iww-hq/reviews', label: 'Reviews', icon: <><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" /></> },
  { href: '/iww-hq/verifications', label: 'Verifications', icon: <><path d="M12 2 4 5.5v5c0 5.2 3.4 9.6 8 10.5 4.6-.9 8-5.3 8-10.5v-5L12 2Z" /><path d="m9 12 2 2 4-4" /></> },
