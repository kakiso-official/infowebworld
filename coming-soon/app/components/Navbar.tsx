  ...
  return (
    <>
      <header className={`hd${scrolled ? ' hd--scrolled' : ''}`}>
        ...
        <div className="hd-top">
          <div className="container hd-top-inner">
            ...
            <CsWrap className="hd-search-wrap">
              <div className="hd-search">
                <svg viewBox="0 0 24 24" className="hd-search-ic">
                  <circle cx="11" cy="11" r="8" /><path d="m21 21-4.3-4.3" />
                </svg>
                <input type="text" className="hd-search-input" placeholder="Search businesses, categories..." readOnly />
              </div>
            </CsWrap>
        ...
        <div className="hd-sub">
          <div className="container hd-sub-inner">
            ...
            <NavItem label="Deals" />
            <NavItem label="News" />
            <Link href="/get-listed" className="hd-sub-cta">
              Get Listed
      ...
      <div className={`hd-drawer${drawerOpen ? ' hd-drawer--open' : ''}`}>
        ...
        <div className="hd-drawer-search">
          <svg viewBox="0 0 24 24" className="hd-search-ic"><circle cx="11" cy="11" r="8" /><path d="m21 21-4.3-4.3" /></svg>
          <input type="text" className="hd-search-input" placeholder="Search businesses..." readOnly />
          <span className="hd-cs-badge">Coming Soon</span>
        </div>
        ...
        <div className="hd-drawer-body">
          ...
          <div className="hd-drawer-link">Deals<span className="hd-cs-badge">Coming Soon</span></div>
