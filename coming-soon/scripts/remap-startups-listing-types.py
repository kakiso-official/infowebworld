#!/usr/bin/env python3
"""
Remap 510 Startups & Innovation listing types from old L3 categories to new L3 categories.
Reads: existing listing types from MySQL DB + new L3s from Excel
Writes: database/migration-remap-startups-listing-types.sql
"""
...
OUT_FILE = os.path.join(OUT_DIR, "migration-remap-startups-listing-types.sql")
...
MANUAL_OVERRIDES = {
    # "By Region" L3s → geographic ecosystem
    ('By Region', 'North America'): 'silicon-valley-tech-ecosystem',
    ('By Region', 'Europe'): 'london-tech-ecosystem',
    ('By Region', 'Asia-Pacific'): 'singapore-tech-ecosystem',
    ('By Region', 'Global'): 'remote-first-startups',
    # DeepTech frontier → advanced materials / quantum (closest deep tech L3s)
    ('By Sector', 'DeepTech'): 'advanced-materials-startups',
    # HealthTech infrastructure → telemedicine (closest healthtech infra)
    ('By Sector', 'HealthTech'): 'telemedicine-startups',
}
...
SYNONYMS = {
    ...
    'investing': 'invest', 'investor': 'invest', 'investors': 'invest',
    'investment': 'invest', 'investments': 'invest',
    'funding': 'fund', 'funded': 'fund', 'funds': 'fund',
    'startups': 'startup',
    'innovation': 'innovat', 'innovations': 'innovat', 'innovative': 'innovat',
    'accelerators': 'accelerat', 'accelerator': 'accelerat',
    'incubators': 'incubat', 'incubator': 'incubat',
...
sql_lines = []
sql_lines.append("-- =================================================================")
sql_lines.append("-- Startups & Innovation Listing Type Remapping")
sql_lines.append(f"-- {len(old_listing_types)} listing types -> {len(assignments)} new L3 categories")
sql_lines.append("-- Generated by remap-startups-listing-types.py")
sql_lines.append("-- =================================================================")
sql_lines.append("")
sql_lines.append("-- Run AFTER migration-startups-taxonomy.sql")
sql_lines.append("")
